        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <img src="{{ asset('images/mrm.png') }}" class="block h-9 w-auto max-w-xs min-w-16 max-h-32 min-h-16" alt="Logo">
                </div>
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @auth
                        ...
                        @endif
                        @if (auth()->user() && auth()->user()->role && (auth()->user()->role->role === 'Admin' || auth()->user()->role->can_assign_roles))
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                @auth
                    ...
                    @if (auth()->user()->active && auth()->user()->role)
                    <div class="font-medium text-sm text-gray-500">{{ Auth::user()->role->role }}</div>
                    @else
                    <div>(Outlaw)</div>
                    @endif                    
                @endauth
